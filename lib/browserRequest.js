    ...
    var responsePromise = new Promise(function (resolve, reject) {
        ...
        req.onreadystatechange = function () {
            if (req.readyState === READY_STATE_DONE) {
                ...
                if (statusCode === 0) {
                    var url = "url: " + reqUrl;
                    var status_1 = "status: " + statusCode;
                    var statusText = "message: " + req.statusText;
                    var responseText = "response: " + req.responseText;
                    reject(new Error("Request error for " + url + " " + status_1 + " " + statusText + " " + responseText));
                    return;
                }
